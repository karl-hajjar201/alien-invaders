...
val items_here: t -> Adventure.item list

val inventory: t -> Adventure.item list

val win_condition : t -> Adventure.t -> bool

val pick : t -> Adventure.t ->Adventure.item -> result
val drop : t -> Adventure.t ->Adventure.item -> result
(* END DO NOT CHANGE
 **********************************************************************)
